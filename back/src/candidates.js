...
export const CANDIDATES = Object.freeze(CATALOG.map((person) => Object.freeze({
  ...
  primaryArea: person.primaryArea || null,
  contextAffiliation: person.contextAffiliation || null,
  taxonomyProvenance: Object.freeze(Object.fromEntries(
    Object.entries(person.taxonomyProvenance || {}).map(([field, provenance]) => [field, Object.freeze({ ...provenance })]),
  )),
