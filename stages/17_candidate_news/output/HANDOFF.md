...
Atualização de 22/09/2026: a pedido de Stefan, a PR única #233 (F01+A01+A02) foi dividida em três PRs empilhadas por unidade, já que os três módulos têm import cruzado e nenhum builda isolado contra `main`. Cadeia: [PR #237](https://github.com/stefancabral-oss/presidencia-duelo/pull/237) (A02, base `main`) → [PR #238](https://github.com/stefancabral-oss/presidencia-duelo/pull/238) (F01, base na branch de A02) → [PR #233](https://github.com/stefancabral-oss/presidencia-duelo/pull/233) (A01, base na branch de F01; fecha a árvore completa e é a única com CI verde). Nenhum código foi alterado; só a estrutura de PRs e a documentação de cada unidade. Ordem de merge recomendada: #237 → #238 → #233.

Atualização de 22/09/2026 (aprovação): Stefan aprovou os três gates humanos (F01, A01, A02) e autorizou o merge da cadeia. Registrado em [A01-verification.json](A01-verification.json), [A02-verification.json](A02-verification.json) e [F01-verification.json](F01-verification.json). A aprovação cobre a decisão de produto/editorial/privacidade do responsável; medição formal de zoom 200% e leitores de tela para F01 continua em aberto. As issues #217/#223/#224 permanecem abertas até seus próprios critérios de conclusão — a aprovação do gate e o merge não as fecham.
