...
CI do novo código [00a2b2a](https://github.com/stefancabral-oss/presidencia-duelo/commit/00a2b2ab40c87dbd60fe39a0ce33458ca64087d9) aprovado: [Backend and Shared](https://github.com/stefancabral-oss/presidencia-duelo/actions/runs/35375790683), com 203 testes backend e integração PostgreSQL 16, e [Civic Planning](https://github.com/stefancabral-oss/presidencia-duelo/actions/runs/35375790684). Merge mecânico desse código com main e PR #232 sem conflitos; cinco threads técnicas resolvidas, zero abertas.

Reforço final da revisão: o CLI exige o manifesto/checksum da entrega, valida o snapshot e recomputa o universo/dossiê contra o lote fixado. Omissão de candidatura, troca de ID eleitoral ou alteração do snapshot não gera uma revisão parcial. São 13 regressões processuais e 461/461 testes locais aprovados (27986.909 ms), após esse reforço. O pacote mantém o mesmo evidenceId porque os fatos não mudaram. CI dessa revisão final será conferido no novo head, sem reutilizar o run 00a2b2a como se validasse o código posterior.

CI final do código [19e1469](https://github.com/stefancabral-oss/presidencia-duelo/commit/19e14690d5c2f29fc2ea0281ac688875a52f7d67) aprovado: [Backend and Shared](https://github.com/stefancabral-oss/presidencia-duelo/actions/runs/35376153177), com 206 testes backend e PostgreSQL 16, e [Civic Planning](https://github.com/stefancabral-oss/presidencia-duelo/actions/runs/35376153176). Sem conflitos com main/PR #232; a coleta processual e o gate humano continuam pendentes nos termos acima.

## Atualização de 21/09/2026

Com a nova intervenção de Stefan na interface do PJe, duas certidões do segundo suplente coletivo de Guto foram consultadas. A revisão DivulgaCandContas das 95 identidades detectou a mudança de situação/urna de Edjane. [Relato, fontes e limites](B02-refresh-2026-09-21.md), [revisão individual](B02-case-review-2026-09-21.json), [fatos de 14 atos](B02-process-evidence-2026-09-21.json) e [revisão processual validada](B02-process-review-2026-09-21.json) são novos artefatos imutáveis. Os anteriores não foram sobrescritos. Seguem pendentes o vínculo expresso do RRCI do segundo suplente, as vigências e os demais atos. `complete=false`; o gate editorial/produto não foi autocertificado.

Após outro check de Stefan, a Decisão 1265 do segundo suplente individual, a certidão dos três RRCI deferidos e a certidão de trânsito foram lidas. [Pacote complementar de 17 atos](B02-process-evidence-2026-09-21-rrci.json) e [revisão validada](B02-process-review-2026-09-21-rrci.json) preservam os artefatos anteriores. A certidão dos RRCI contém erro material aparente no número do segundo suplente, registrado no [relato](B02-refresh-2026-09-21.md). Ainda falta o ato que cite ambos os números de processo do segundo suplente e a prova dos períodos; a consulta coletiva novamente apresentou desafio. A revisão humana continua necessária.
